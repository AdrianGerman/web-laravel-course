            ...
            <div class="max-w-2xl">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div class="rounded-full px-4 py-2 text-sm text-gray-600 border border-gray-300">
                        Resuelve tus preguntas de programación. <a href="#"
                            class="font-semibold text-indigo-600">Acerca de &rarr;</a>
                    </div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <div class="flex items-center justify-center gap-6">
                        ...
                        @guest
                            <a href="{{ route('login') }}" class="text-sm font-semibold text-gray-900">Login
                                &rarr;</a>
                        @endguest
                    </div>
                </div>
