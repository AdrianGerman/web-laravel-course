<div class="mb-4">
    ...
    <input type="text" name="title" class="w-full p-2 border border-gray-700 rounded-md" value="" />
...
<div class="mb-4">
    ...
    <textarea name="description" rows="6" class="w-full p-2 border border-gray-700 rounded-md"></textarea>
